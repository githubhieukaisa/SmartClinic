...
namespace SmartClinic.Migrations
{
    ...
    [Migration("20260329153840_AddReconciliationAuditFields")]
    partial class AddReconciliationAuditFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartClinic.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 8,
                            Code = "XN_CDHA",
                            CreatedAt = new DateTime(2026, 3, 29, 22, 38, 39, 777, DateTimeKind.Local).AddTicks(4102),
            ...
            modelBuilder.Entity("SmartClinic.Models.Entites.CashierReconciliation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("ExpectedVNPayTotal")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("ReportDate", "CashierId")
                        .IsUnique();

                    b.ToTable("CashierReconciliations");
                });

            modelBuilder.Entity("SmartClinic.Models.Entites.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartClinic.Models.HistoryAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasKey("Id")
                        .HasName("HistoryAccess_pkey");

                    b.HasIndex("QueueTicketId")
                        .IsUnique();

                    b.ToTable("HistoryAccesses");
                });
            ...
            modelBuilder.Entity("SmartClinic.Models.Entites.CashierReconciliation", b =>
                {
                    b.HasOne("SmartClinic.Models.User", "Cashier")
                        .WithMany()
                        .HasForeignKey("CashierId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartClinic.Models.User", "ConfirmedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartClinic.Models.HistoryAccess", b =>
                {
                    b.HasOne("SmartClinic.Models.QueueTicket", "QueueTicket")
                        .WithOne("HistoryAccess")
                        .HasForeignKey("SmartClinic.Models.HistoryAccess", "QueueTicketId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
